...
const Sidebar = () => {
  ...
  const [callCenterExpanded, setCallCenterExpanded] = useState(false);
      ...
      items: [
        {
          ...
          href: '/callcenter',
          icon: Headphones,
          description: 'Dashboard de call center',
          resource: 'callcenter'
        },
        {
          name: 'Relatórios',
    ...
    <div className="bg-white border-r border-gray-200 w-64 min-h-screen overflow-y-auto">
      <div className="p-6">
        ...
        <nav className="space-y-6">
          ...
          <div className="space-y-1">
            <button
              onClick={() => setCallCenterExpanded(!callCenterExpanded)}
