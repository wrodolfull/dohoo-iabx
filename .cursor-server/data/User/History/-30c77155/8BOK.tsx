            ...
            <div className="space-y-4">
              <div>
                ...
                <Select
                  ...
                  onValueChange={value => setFormData({ ...formData, preset: value, regex_pattern: '' })}
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={value => setFormData({ ...formData, trunk_fallback: value })}
                >
                  <SelectTrigger>
              ...
              {formData.destination_type === 'extension' && (
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      {extensions.map(ext => (
                        <SelectItem key={ext.id} value={ext.id}>{ext.number} - {ext.name}</SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
                </div>
              ...
              {formData.destination_type === 'ringgroup' && (
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      {ringGroups.map(rg => (
                        <SelectItem key={rg.id} value={rg.id}>{rg.number} - {rg.name}</SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
                </div>
