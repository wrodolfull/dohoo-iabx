...
const Users = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {/* Campo de busca igual ao Extensions */}
      <section className="w-full">
        <div className="flex items-center w-full max-w-xl ml-auto mb-4">
          <div className="relative w-full">
            ...
            <Input
              ...
              className="pl-10 pr-4 py-2 w-full rounded-lg border border-gray-200 focus:border-dohoo-primary focus:ring-1 focus:ring-dohoo-primary bg-white shadow-none"
              value={search}
