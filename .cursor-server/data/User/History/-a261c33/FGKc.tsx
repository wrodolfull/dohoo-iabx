              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-3">
                  ...
                  <Button 
                    ...
                    disabled={
                      user.id === user?.id || // Não pode excluir a si mesmo
                      (user?.role === 'admin' && user.role === 'superadmin') || // Admin não pode excluir superadmin
                      (user?.role !== 'superadmin' && user?.role !== 'admin') // Só superadmin e admin podem excluir
                    }
                  >
