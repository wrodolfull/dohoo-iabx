                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 mt-2">
                      {(editingNode.data?.timeRanges || [{ start: '09:00', end: '18:00' }]).map((range: any, index: number) => (
                        <div key={index} className="flex items-center gap-2">
                          <Input
                            type="time"
                            value={range.start || '09:00'}
                            onChange={(e) => {
                              const currentRanges = editingNode.data?.timeRanges || [{ start: '09:00', end: '18:00' }];
                          ...
                          <Input
                            ...
                            className="w-24"
                          />
                          {(editingNode.data?.timeRanges || []).length > 1 && (
                            <Button
                              type="button"
                              variant="outline"
                              size="sm"
