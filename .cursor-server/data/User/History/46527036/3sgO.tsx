...
const HangupNode = ({ data }: any) => (
  <div className="bg-red-100 border-2 border-red-300 rounded-lg p-3 min-w-[200px] relative cursor-pointer hover:bg-red-50 transition-colors">
    <Handle
      type="target"
      position={Position.Left}
...
const AINode = ({ data }: any) => (
  <div className="bg-orange-100 border-2 border-orange-300 rounded-lg p-3 min-w-[200px] relative cursor-pointer hover:bg-orange-50 transition-colors">
    <Handle
      type="target"
      position={Position.Left}
      className="w-3 h-3 bg-orange-500 border-2 border-white"
    ...
    <div className="text-sm text-orange-600 mt-1">{data.projectId || 'Projeto'}</div>
    <div className="text-xs text-orange-700 bg-orange-50 p-1 rounded mt-1">
      {data.agentId || 'Agente'}
    </div>
    <Handle
      type="source"
              ...
              {editingNode.type === 'extension' && (
                <div className="space-y-3">
                  <div>
                    ...
                    <Input
                      id="extension"
                      value={(editingNode.data?.extension as string) || ''}
                      onChange={(e) => updateNode({ extension: e.target.value })}
                      placeholder="Ex: 1001"
                    />
                  </div>
                  <div>
              ...
              {editingNode.type === 'group' && (
                <div className="space-y-3">
                  <div>
                    ...
                    <Input
                      id="group-id"
                      value={(editingNode.data?.groupId as string) || ''}
                      onChange={(e) => updateNode({ groupId: e.target.value })}
                      placeholder="Ex: grupo-atendimento"
                    />
                  </div>
                  <div>
