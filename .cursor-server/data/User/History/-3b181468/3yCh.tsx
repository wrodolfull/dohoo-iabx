          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4 p-4 bg-blue-50 rounded-lg border">
              ...
              {generateExtension && mode === 'create' ? (
                <div className="space-y-2">
                  <Label>Próximo Ramal Disponível</Label>
                  <div className="flex items-center gap-2">
                    {loadingExtension ? (
                      <div className="flex items-center gap-2 text-blue-600">
                        <Loader2 className="w-4 h-4 animate-spin" />
                        <span className="text-sm">Buscando ramal...</span>
                      </div>
                    ) : nextAvailableExtension ? (
                      <div className="flex items-center gap-2">
                        <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">
                          <CheckCircle className="w-3 h-3 mr-1" />
                          Ramal {nextAvailableExtension}
                        </Badge>
                        <span className="text-sm text-gray-600">será atribuído automaticamente</span>
                      </div>
                    ) : (
                      <Alert>
                        <AlertCircle className="h-4 w-4" />
                        <AlertDescription>
                          Não foi possível obter próximo ramal disponível
                        </AlertDescription>
                      </Alert>
                    )}
                  </div>
