...
const UserForm: React.FC<UserFormProps> = ({ 
  ...
  const fetchAvailableExtensions = async () => {
    try {
      ...
      console.error('Erro ao buscar ramais existentes:', error);
    }
  };
  ...
  const handleExtensionToggle = (checked: boolean) => {
    ...
    if (checked) {
      // fetchNextExtension(); // Removed as per new logic
      // fetchAvailableExtensions(); // Removed as per new logic
    } else {
                ...
                <div className="space-y-2">
                  ...
                  {availableExtensions.length > 0 ? (
                    <Select
                      ...
                      onValueChange={(value) => handleInputChange('extension', value)}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Selecione um ramal (opcional)" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="">Nenhum ramal</SelectItem>
