        ...
        <Card>
          ...
          <CardContent>
            <select 
              value={tenantId || ''} 
              onChange={(e) => {
                // This selector is now managed by useTenant, so we don't need to update tenantId here directly.
                // The useTenant hook will handle the change.
              }}
              className="w-full p-2 border border-gray-300 rounded-md"
            >
              {/* This option will be populated by useTenant */}
