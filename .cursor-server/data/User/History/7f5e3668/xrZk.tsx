    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="text-gray-600">Escolha uma empresa para gerenciar suas rotas de entrada</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      {isSuperAdmin && (
        <TenantSelector
          ...
          description="Escolha a empresa cujas rotas de entrada você deseja gerenciar"
        />
      )}
