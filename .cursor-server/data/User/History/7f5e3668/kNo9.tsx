...
interface InboundRoute {
  ...
  tenant_id: string;
  created_at: string;
  source_ip?: string; // Adicionado para o novo campo
}
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label htmlFor="source_ip">IP de Origem (opcional)</Label>
                <Input
                  id="source_ip"
                  ...
                  className=""
                />
                <span className="text-xs text-gray-500">Se preenchido, só aceitará chamadas deste IP (network_addr do FreeSWITCH)</span>
              </div>
            </div>
