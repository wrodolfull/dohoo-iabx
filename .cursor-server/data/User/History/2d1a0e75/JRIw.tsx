              ...
              {surveyConfig.enabled && (
                <div className="mt-2">
                  ...
                  <Select
                    ...
                    options={surveys.map(s => ({ value: s.id, label: s.name, question_text: s.question_text }))}
                    value={surveys
                      .map(s => ({ value: s.id, label: s.name, question_text: s.question_text }))
                      .find(opt => opt.value === surveyConfig.survey_template_id) || null}
                    onChange={option => setSurveyConfig(s => ({
                      ...s,
                      survey_template_id: option?.value || null
                    }))}
                    isClearable
