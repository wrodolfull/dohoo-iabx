...
const RingGroups = () => {
  ...
  const handleEdit = (ringGroup: RingGroup) => {
    ...
    setFormData({
      ...
      type: ringGroup.strategy,
      timeout: ringGroup.timeout,
      extensions: [], // Extensions are not part of the RingGroup interface, so they are not set here
      is_active: true // Assuming all groups are active for editing
    });
