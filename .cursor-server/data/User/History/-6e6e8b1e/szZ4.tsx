...
const ROLE_RESOURCES = {
  superadmin: [
    ...
    'reports', 'calls', 'settings', 'schedules', 'freeswitch-admin', 'callcenter', 'advanced-reports'
  ],
  admin: [
    'dashboard', 'extensions', 'ringgroups', 'ura', 'trunks', 
    'routes', 'users', 'reports', 'calls', 'settings', 'schedules', 'callcenter', 'advanced-reports'
  ],
  agent: [
