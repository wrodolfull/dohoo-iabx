...
const ROLE_RESOURCES = {
  superadmin: [
    ...
    'reports', 'calls', 'settings', 'schedules', 'freeswitch-admin', 'callcenter'
  ],
  admin: [
    'dashboard', 'extensions', 'ringgroups', 'ura', 'trunks', 
    'routes', 'users', 'reports', 'calls', 'settings', 'schedules', 'callcenter'
  ],
  agent: [
    'dashboard', 'extensions', 'reports', 'calls', 'profile', 'callcenter'
  ]
};
